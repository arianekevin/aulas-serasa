...
//		
	...
	Gerente funcionario1 = new Gerente("Ariane Casas", "048.197.675-26", "58968", LocalDate.now(), 4500.0);
	
	System.out.println(funcionario1.toString());
	
	System.out.printf("Bônus: %.2f \n", funcionario1.getBonus());
	...
	System.out.println(funcionario1.alterarUsuario("admin", "admin", "ariane"));
